...
export async function fetchConversationForUser(req:Request<FetchConversationForUserParams>,res:Response) 
{
    try {
        ...
        }).select('conversationId type name').lean<ConversationPreview[]>()      
